...
public class OBJLoader {
	public static RawModel loadObjModel(String fileName, Loader loader){
		...
		try {
			...
			System.err.println("Cound not find file");
			e.printStackTrace();
		}
		...
		try{
			while(true){
				...
				textures.add(texture);
					...
					textureArray = new float[vertecies.size()*2];
	...
	return loader.loadtoVAO(verteciesArray,textureArray,normalsArray,indicesArray);
	}
